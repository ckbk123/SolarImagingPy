...
def calibrate_camera(pattern_cols, pattern_rows, square_size, images):
    ...
    print(f"{Fore.LIGHTMAGENTA_EX}Total images with detected checkerboards: " + str(
        nb_images_used_for_calib) + f"{Style.RESET_ALL}")
    ...
    print(
        f"{Fore.LIGHTYELLOW_EX}The calibration is started. Module courtesy of Thomas Pönitz, Github: https://github.com/tasptz/py-omnicalib{Style.RESET_ALL}")
