...
def compute_diffuse_shading_factor_NASA(image, poly_incident_angle_to_radius, principal_point, estimated_fov, im_height, im_width):
    print(f"{Fore.YELLOW}Computing global DIFFUSE shading factor...{Style.RESET_ALL}")

    ## OK SO HERES THE PROBLEM: WE MUST ASSUME THAT THE USER TAKE THE PHOTO HORIZONTAL TO GROUND
    ## BUT MAYBE WE SHOULD HAVE AN OPTION FOR THAT STILL?
